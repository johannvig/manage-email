...
def verify_email(row_number, file_path, webhook_url, discord_bot_name, discord_bot_icon):
    try:
        with open(file_path, 'r') as csv_file:  # path of "verify email.csv" file
            ...
            # Create SMTP session to verify the mail
            ...
            print(Fore.GREEN + 'Successfully verified')

            # Track all mail that you verified with a discord webhook
            ...
            embed.add_embed_field(name='Tool', value="Verify email", inline=False)
...
if __name__ == "__main__":
    file_path = ''  # put the path of "verify email.csv" file
    ...
    while True:
        with open(file_path, 'r') as csv_file:  # path of "verify email.csv" file
            ...
            if k == "no":
                ...
                verify_email(row_number, file_path, webhook_url, discord_bot_name, discord_bot_icon)
                s += 1
